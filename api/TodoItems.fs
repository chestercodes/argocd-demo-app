...
module TodoItems =
    ...
    type ValidatedTodoItem = { Content: string; IsComplete: bool }
            ...
            taskResult {
                try
                    let! id =
                        ...
                        |> Sql.connect
                        |> Sql.query
                            "INSERT INTO public.todoitems (content, is_complete) VALUES (@content, @is_complete) RETURNING id "
                        |> Sql.parameters [
    ...
    module Service =
        type TodoItemsGetAllError = DbError of exn
